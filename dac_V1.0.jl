...
pi_co2 = 40 # selling co2 at pi_co2 per ton
# default: pi_co2 = 180
...
N_start = 1001; # number of starting day
...
for t = 1:nH# go through each step
    ...
    if n > 1 && t == 1
        ...
        set_normalized_rhs(ab_1, beta_a_1 + beta_a_2*X0/2)
        set_normalized_rhs(de_1, beta_d_1 + beta_d_2*X0/2)
