...
beta_a_2 = -0.2; % Piecewise linear approximation for absorption, second-order term
beta_d_1 = 0.0*X_hat; % Piecewise linear approximation for desorption, first-order term
beta_d_2 = 0.4; % Piecewise linear approximation for desorption, second-order term
