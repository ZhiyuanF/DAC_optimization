function [lambda_opts,profits] = LambdaOptimizer(price_data, increment, look_ahead, X, k, parameters)
    ...
    for chunk = 1:chunks
        ...
        [lambda_opt, ~] = SingleLambdaOptimizer(small_price_data, X, k, parameters);
        ...
        [X, k, profit] = DAC_foriteration(lambda_opt, small_price_data, X, k, parameters);
